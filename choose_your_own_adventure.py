...
if answer == 'left':
    answer = input('You come to a river, you can walk around it or swim acoss? Type walk to walk around and swim to swim across: ').lower()
    ...
    if answer == "swim":
        ...
        print('Not avlid option. You lose')
    ...
    if answer == "back":
        ...
        if answer == "yes":
            print("You talk to the stranger an dthey give you the gold. You WIN!")
        elif answer == 'no':
